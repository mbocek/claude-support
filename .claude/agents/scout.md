...
2. Search broadly before reading deeply: `Glob` for layout, `Grep` for symbols and patterns, `Read` only the excerpts needed to confirm a finding. Prefer several targeted searches over reading whole files.
